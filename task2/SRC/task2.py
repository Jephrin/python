...
coordinates = re.findall("[-+]?\d+\.\d+|[-+]?\d+", data)#Нашли все координаты(по мимо координат,мы вытаскиваем номера треугольников, которые мы в дальнейшем уберем из массива)
#Удаление номеров треугольника
del coordinates[10]
del coordinates[0]
